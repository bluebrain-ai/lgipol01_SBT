...
public class Lgipol01 {
    ...
    @Value("${api.lgipdb01.host}")
    private String lgipdb01_HOST;
    @Value("${api.lgipdb01.uri}")
    private String lgipdb01_URI;
    ...
    public ResponseEntity<Dfhcommarea> mainline(@RequestBody Dfhcommarea payload) {
        ...
        emVariable.setEmPolnum(String.valueOf(dfhcommarea.getCaPolicyRequest().getCaPolicyNum()));
        try {
